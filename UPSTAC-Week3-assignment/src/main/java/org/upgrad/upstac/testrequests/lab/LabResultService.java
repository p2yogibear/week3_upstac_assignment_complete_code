...
public class LabResultService {
    ...
    private LabResult createLabResult(User tester, TestRequest testRequest) {
        ...
        labResult.setTestRequest(testRequest);
    ...
    public LabResult updateLabTest(TestRequest testRequest, CreateLabResult createLabResult) {
        ...
        LabResult labResult = new LabResult();
        labResult.setTestRequest(testRequest);
        labResult.setBloodPressure("high");
        labResult.setComments("Need Medication");
        labResult.setHeartBeat("high");
        labResult.setOxygenLevel("Low");
