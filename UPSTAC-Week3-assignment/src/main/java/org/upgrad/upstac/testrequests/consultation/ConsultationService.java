...
public class ConsultationService {
    ...
    public Consultation assignForConsultation( TestRequest testRequest, User doctor) {
        ...
        consul.setRequest(testRequest);
        consul.setDoctor(doctor);
        return consul;

    }

   // private Consultation save(Consultation consul) {
    //}
    ...
    public Consultation updateConsultation(TestRequest testRequest , CreateConsultationRequest createConsultationRequest) {
        ...
        Consultation consul = new Consultation();
        consul.setRequest(testRequest);
        consul.setComments("Need further examination");
        consul.setUpdatedOn(LocalDate.parse("10.10.2020"));
        return consul;
